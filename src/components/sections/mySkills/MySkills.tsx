    ...
    <>
      ...
      <div className={styles.skillsWrapper}>
        ...
        <Dialog>
          <DialogContent>
            <p>
              Basically everything I remember using during my career or my
              studies (I'm sure I'm forgetting a lot). And some characters from
              Greek mythology to spice things up. Can you find them all?
            </p>
            <p>
              Best and simplest evaluation of my skills that I can think of -
              not exact for all the technologies, but gives a general idea:
            </p>
